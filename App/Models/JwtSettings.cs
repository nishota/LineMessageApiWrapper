namespace Aimnext.MessageApiWrapper.App.Models;

// TODO: あとで別ファイルからもらってくる。
// TODO: プロトタイプの実装が終わったら、チャンネルを消す。
public static class JwtSettings
{
    public static Dictionary<string, object> PayLoad => new()
    {
        {"iss", "1657535572"},
        {"sub", "1657535572"},
        {"aud", "https://api.line.me/"},
        {"exp", new DateTimeOffset(DateTime.Now.Ticks, new TimeSpan(+09, 00, 00)).ToUnixTimeSeconds() + 60 * 30}, // UnixTime
        {"token_exp", 60 * 60 * 24 * 30}
    };
    public static Dictionary<string, object> Header => new()
    {
        {"alg", "RS256"},
        {"typ", "JWT"},
        {"kid", "ae102522-2f6d-4de2-9e69-3f78616ffadc"}
    };
    public static Dictionary<string, object> Jwk => new()
    {
        {"key_ops", new List<string>{"sign"}},
        {"ext", true},
        {"kty", "RSA"},
